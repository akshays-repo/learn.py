...
while True:
    if (int(questionNumber) == 1):questionOne()

    if (int(questionNumber) == 2):questionTwo()

    if (int(questionNumber) == 3):questionThree()

    if (int(questionNumber) == 4):questionFour()

    if (int(questionNumber) == 5):questionFive()

    if (int(questionNumber) == 6):questionSix()

    if (int(questionNumber) == 7):questionSeven()

    if (int(questionNumber) == 8):questionEight()
