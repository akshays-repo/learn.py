# -*- coding: utf-8 -*-
"""
Created on Tue Jul 14 13:43:14 2020
...
letters = pd.read_csv("/home/akshays/Desktop/learn.py/files.py/SVM/letters.csv")
letters.describe()
letters.columns

sns.boxplot(x="lettr",y="x-box",data=letters,palette = "hls")
sns.boxplot(x="y-box",y="lettr",data=letters,palette = "dark")
